package fr.maxlego08.ztranslator.inventory;
...
import fr.maxlego08.ztranslator.exceptions.InventoryOpenException;
import fr.maxlego08.ztranslator.zcore.utils.ZUtils;
import fr.maxlego08.ztranslator.zcore.utils.builder.ItemBuilder;
import fr.maxlego08.ztranslator.zcore.utils.inventory.InventoryResult;
import fr.maxlego08.ztranslator.zcore.utils.inventory.ItemButton;

public abstract class VInventory extends ZUtils implements Cloneable {

	protected int id;
	protected TranslatorPlugin plugin;
	...
	protected InventoryResult preOpenInventory(TranslatorPlugin main, Player player, int page, Object... args)
	...
	public abstract InventoryResult openInventory(TranslatorPlugin main, Player player, int page, Object... args)
			throws InventoryOpenException;
	 ...
	 * @param player
	 */
	protected void onClose(InventoryCloseEvent event, TranslatorPlugin plugin, Player player) {
	}
	 ...
	 * @param player
	 */
	protected void onDrag(InventoryDragEvent event, TranslatorPlugin plugin, Player player) {
	}
