package fr.maxlego08.ztranslator.command;
...
import fr.maxlego08.ztranslator.zcore.utils.commands.Arguments;
import fr.maxlego08.ztranslator.zcore.utils.commands.CollectionBiConsumer;
import fr.maxlego08.ztranslator.zcore.utils.commands.CommandType;
import fr.maxlego08.ztranslator.zcore.utils.commands.Tab;

public abstract class VCommand extends Arguments {

	protected final TranslatorPlugin plugin;
	 ...
	 * @param plugin
	 */
	public VCommand(TranslatorPlugin plugin) {
		super();
		this.plugin = plugin;
	}
	 ...
	 * @return
	 */
	public CommandType prePerform(TranslatorPlugin plugin, CommandSender commandSender, String[] args) {
	 ...
	 */
	protected abstract CommandType perform(TranslatorPlugin plugin);
	 ...
	 * @return
	 */
	public List<String> toTab(TranslatorPlugin plugin, CommandSender sender, String[] args) {
